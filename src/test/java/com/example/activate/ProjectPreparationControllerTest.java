...
public class ProjectPreparationControllerTest {
    ...
    public void testAddProjectPreparation() throws Exception {
        ProjectPreparation projectPreparation = new ProjectPreparation("1", "2024-01-01", "2024-12-31", "John Doe", "Jane Smith", "Business Analyst", "Objectives", "Planning", "Validation", "Roles", "Governance", "Risk", "Budget", "Communication");
    ...
    public void testGetAllProjectPreparations() throws Exception {
        ProjectPreparation projectPreparation1 = new ProjectPreparation("1", "2024-01-01", "2024-12-31", "John Doe", "Jane Smith", "Business Analyst", "Objectives", "Planning", "Validation", "Roles", "Governance", "Risk", "Budget", "Communication");
        ProjectPreparation projectPreparation2 = new ProjectPreparation("2", "2024-02-01", "2024-11-30", "Alice", "Bob", "Analyst", "Goals", "Plan", "Check", "Role", "Proc", "Assess", "Funds", "Comm");
